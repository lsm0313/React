...
class DetailsWorkStatus extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        return (this.state.Data!==nextState.Data) || (this.state.drawerOpened !== nextState.drawerOpened) || (this.state.csvData!==nextState.csvData) || 
                        ...
                        <Paper className={classes.paper}>
                            <Table size = 'small' className={classes.table}>
                                ...
                                <TableRow>
                                    ...
                                    {this.props.location.state.first_in_reason==="수A" ||  this.props.location.state.status_code === "수A" || this.props.location.state.first_in_reason==="위탁"?
