...
class adminView extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    (nextState.checkerFilter !==this.state.checkerFilter) || (nextState.sortChk !==this.state.sortChk) || (nextState.drawerOpened !== this.state.drawerOpened) || (this.state.csvData==='') ||
