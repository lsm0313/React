...
class userView extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    return (this.state.customers==='') || (nextState.searchKeyword !== this.state.searchKeyword) || (nextState.classifyFilter !==this.state.classifyFilter)  || (this.state.csvData==='') || 
  ...
  render = () => {    
    const filteredComponents = (data) => {
      ...
      return data.map((c) => {
        return <CustomerUser stateRefresh={this.stateRefresh} key={c.IDX} id={c.IDX} classify={c.classify} first_in_reason={c.first_in_reason} company={c.company} 
    ...
    try{
      if(this.props.location.state.admin === 0){    
                  ...
                  <div className={classes.search}>
                    ...
                    <Route render={({ history}) => (
                      <InputBase
                        ...
                        name="searchKeyword"
                        value={this.state.searchKeyword.toUpperCase()}
                        onChange={this.handleValueChange}
                        onKeyPress={e=>{if (e.key==='Enter'){
                            if(this.state.searchKeyword.length >= 2){
                              ...
                              state :{ 
                                searchKeyword : this.state.searchKeyword.toUpperCase(),
                ...
                <Table size = 'small'>
                  <TableHead>
                      <TableRow>
                        ...
                        <TableCell className={classes.tableHead} align = 'center'><div>기타</div></TableCell>
                      </TableRow>
                    </TableHead>
                  <TableBody>
                  <TableCell className={classes.table}></TableCell>
                  <TableCell align="center" className={classes.table}><TextField placeholder="분류" name="classifyFilter" style ={{width: '50px'}} value={this.state.classifyFilter} onChange={this.handleValueChange}/></TableCell>
                    <TableCell align="center" className={classes.table}></TableCell>
                    <TableCell align="center" className={classes.table}><TextField placeholder="의뢰 업체명" name="companyFilter" style ={{width: '110px'}} value={this.state.companyFilter} onChange={this.handleValueChange}/></TableCell>
                    ...
                    <TableCell align="center" className={classes.table}></TableCell>
                    <TableCell align="center" className={classes.table}></TableCell>
                    <TableCell align="center" className={classes.table}><TextField placeholder="입출고(상태)" name="status_codeFilter" style ={{width: '70px'}} value={this.state.status_codeFilter} onChange={this.handleValueChange}/></TableCell>
                    <TableCell align="center" className={classes.table}></TableCell>
                    <TableCell align="center" className={classes.table}></TableCell>
