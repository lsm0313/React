...
class Customer extends React.Component {
    ...
    handleSearch = (e) =>{
        if(this.props.first_in_reason==='BF'){
            const url = "http://ec2-15-165-183-247.ap-northeast-2.compute.amazonaws.com/qrcodejs-master/?carNumber="+this.props.chassis_no+"&initial=BF&first_in_reason=BF&reg_date="+this.props.reg_date.substring(0,10);
            window.open(url, "","location=no,width=2000,height=1000")
        }else{
            const url = "http://ec2-15-165-183-247.ap-northeast-2.compute.amazonaws.com/qrcodejs-master/?carNumber="+this.props.chassis_no+"&initial="+this.props.initial+"&first_in_reason="+this.props.first_in_reason+"&reg_date="+this.props.reg_date.substring(0,10);
            window.open(url, "","location=no,width=2000,height=1000")
        }
    }
    ...
    handleClick = () =>{
        ...
        const url = "http://ec2-15-165-183-247.ap-northeast-2.compute.amazonaws.com/index.php?carNumber="+this.props.chassis_no
            ...
            return (
                <TableRow> 
                    ...
                    <Grid container spacing={-1} align = 'center'>
                        <Grid item>
                            <CustomerUpdate stateRefresh={this.props.stateRefresh} style={{paddingTop:5}} id = {this.props.id} userName={this.props.userName} chassis_no={this.props.chassis_no}/>
                        </Grid>
                        <Grid item>
                            <CustomerDelete stateRefresh={this.props.stateRefresh} id = {this.props.id} userName={this.props.userName} chassis_no={this.props.chassis_no}/>
                        </Grid>
                        <div>
                    ...
                    <Dialog open={this.state.open} onClose={this.handleClose}>
                        ...
                        <DialogContent>
                            <div align="center">
                                ...
                                <br/><br/>
                                <FormControl>
                                    <WorkAdd onClick={this.handleClose} chkDetail={1} check={1} first_in_reason={this.props.first_in_reason} status_code={this.props.status_code} admin = {this.props.admin} userName={this.props.userName} main_IDX={this.props.id} chassis_no={this.props.chassis_no}/>
                                </FormControl>
                                <br/><br/>
                                <FormControl>
                                    <Button variant="contained" color="primary" onClick={()=>{ 
